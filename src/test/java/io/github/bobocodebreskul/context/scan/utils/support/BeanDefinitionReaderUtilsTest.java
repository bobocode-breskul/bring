package io.github.bobocodebreskul.context.scan.utils.support;
...
public class BeanDefinitionReaderUtilsTest {
  ...
  void givenEqualClassNames_WhenGenerateBeanNames_ThenReturnUniqueBeanName() {
    ...
    var abd2 = new AnnotatedGenericBeanDefinition(
        io.github.bobocodebreskul.context.scan.utils.support.test.data.MyComponent.class);
    ...
    String expectedBeanName2 = io.github.bobocodebreskul.context.scan.utils.support.test.data.MyComponent.class.getName();
