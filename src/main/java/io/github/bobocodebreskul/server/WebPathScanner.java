...
/**
 * This class is responsible for scanning and creating web paths. It uses bring container to retrieve
 * all Beans marked as {@link RestController} then retrieve path and http method from public methods
 * marked as {@link Post}, {@link Get}, {@link Delete}, {@link Put}, {@link Head}, {@link RequestMapping}
 */
@Slf4j
public class WebPathScanner {
  ...
  /**
   * This method is responsible for scanning and creating web paths. It uses bring container to retrieve
   * all Beans marked as {@link RestController} then retrieve path and http method from public methods
   * marked as {@link Post}, {@link Get}, {@link Delete}, {@link Put}, {@link Head}, {@link RequestMapping}
   *
    ...
    for (Object controllerBean : getControllerBeans()) {
      ...
      for (Method method : controllerClass.getMethods()) {
        ...
        if (method.isAnnotationPresent(RequestMapping.class)) {
          ...
          String path = prefixPath.concat(invokeAnnotationMethod(httpMethodAnnotation, "value").toString()).toLowerCase();
          validatePath(path);
