...
class BringHttpEntityTest {
  ...
  @Test
  void given_BringHttpEntity_When_AddHeader_Then_HeaderIsSuccessfullyAdded()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
  ...
  @Test
  void given_BringHttpEntity_When_AddHeaderWithNullName_Then_ThrowIllegalArgumentException() {
    // given
    BringHttpEntity<Object> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    ...
    assertThat(actualException)
        ...
        .hasMessage(BringHttpEntity.HEADER_NAME_SHOULD_NOT_BE_NULL);
  }

  @Order(3)
  @DisplayName("Adding header with null name should throw IllegalArgumentException")
  @Test
  void given_BringHttpEntity_When_AddHeaderWithNullValue_Then_ThrowIllegalArgumentException() {
    // given
    BringHttpEntity<Object> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    ...
    assertThat(actualException)
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage(BringHttpEntity.HEADER_VALUE_SHOULD_NOT_BE_NULL);
  }
  ...
  @Test
  void given_BringHttpEntity_When_GetHeader_Then_ReturnHeaderValue()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
  ...
  @Test
  void given_BringHttpEntity_When_GetNonExistingHeader_Then_ReturnEmptyString() {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
  ...
  @Test
  void given_BringHttpEntity_When_RemoveHeader_Then_HeaderIsSuccessfullyRemoved()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    Field headers = response.getClass().getDeclaredField("headers");
  ...
  @Test
  void given_BringHttpEntity_When_RemoveHeaderCookie_Then_CleanCookies()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    Field headers = response.getClass().getDeclaredField("headers");
    headers.setAccessible(true);
    Map<String, String> headersMap = (Map<String, String>) headers.get(response);
    headersMap.put(BringHttpEntity.COOKIE, TEST_HEADER_VALUE);
    headers.setAccessible(false);
  ...
  @Test
  void given_BringHttpEntity_When_RemoveNonExistingHeader_Then_NotRemoved()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    Field headers = response.getClass().getDeclaredField("headers");
  ...
  @Test
  void given_BringHttpEntity_When_AddCookie_Then_CookieIsSuccessfullyAdded()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
  ...
  @Test
  void given_BringHttpEntity_When_AddCookie_Then_CookieIsSuccessfullyAddedToHeaders()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    ...
    Map<String, String> actual = (Map<String, String>) headers.get(response);
    assertThat(actual)
        .containsEntry(BringHttpEntity.COOKIE, TEST_COOKIE_NAME + "=" + TEST_COOKIE_VALUE);
    headers.setAccessible(false);
  }
  ...
  @Test
  void given_BringHttpEntity_When_AddCookieWithNullName_Then_ThrowIllegalArgumentException() {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    ...
    assertThat(actualException)
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage(BringHttpEntity.COOKIE_NAME_SHOULD_NOT_BE_NULL);
  }

  @Order(12)
  @DisplayName("Adding cookie with null value should throw IllegalArgumentException")
  @Test
  void given_BringHttpEntity_When_AddCookieWithNullValue_Then_ThrowIllegalArgumentException() {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    ...
    assertThat(actualException)
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage(BringHttpEntity.COOKIE_VALUE_SHOULD_NOT_BE_NULL);
  }
  ...
  @Test
  void given_BringHttpEntity_When_RemoveCookie_Then_CookieIsSuccessfullyRemoved()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    Field cookies = response.getClass().getDeclaredField("cookies");
  ...
  @DisplayName("Check that removing non existing header doesn't removed anything")
  @Test
  void given_BringHttpEntity_When_RemoveNonExistingCookie_Then_NotRemoved()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    Field cookies = response.getClass().getDeclaredField("cookies");
  ...
  @DisplayName("Adding cookie with null value should throw IllegalArgumentException")
  @Test
  void given_BringHttpEntity_When_RemoveCookieWithNullName_Then_ThrowIllegalArgumentException() {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
  ...
  @Test
  void given_BringHttpEntity_When_RemoveCookie_Then_RemovedCookieFromHeaders()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<ResponseBodyEnum> response = new BringHttpEntity<>(ResponseBodyEnum.NONE);
    response.addCookie(TEST_COOKIE_NAME, TEST_COOKIE_VALUE);
  ...
  @Test
  void given_BringHttpEntity_When_SetBody_Then_BodyIsSuccessfullySet()
      throws NoSuchFieldException, IllegalAccessException {
    // given
    BringHttpEntity<String> response = new BringHttpEntity<>("");
  ...
  @Test
  void given_BringHttpEntity_When_GetBody_Then_BodyIsSuccessfullyGet() {
    // given
    BringHttpEntity<String> response = new BringHttpEntity<>("");
    response.setBody("Test body");
